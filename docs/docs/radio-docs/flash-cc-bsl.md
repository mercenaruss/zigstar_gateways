...
=== "Windows"
    ...
    Download [Python for Windows](https://www.python.org/downloads/){target=_blank} and install. After installation verify Python if its installed by running `python -V` in Command Prompt.
