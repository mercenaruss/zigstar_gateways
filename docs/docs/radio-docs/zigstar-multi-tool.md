...
[ZigStar Multi Tool](https://github.com/xyzroe/ZigStarGW-MT){target=_blank} is GUI tool designed for easy work with ZigStar LAN GW and USB Stick and packed into single executable file.<br>
...
![ZigStar GW Multi Tool](/images/radio-docs/multitool/multitool-1.png){: style="height:50%;width:50%" loading=lazy}
...
![Multi Tool FLASH](/images/radio-docs/multitool/multitool-2.png){: style="height:50%;width:50%" loading=lazy}
...
![Multi Tool NVRAM](/images/radio-docs/multitool/multitool-3.png){: style="height:50%;width:50%" loading=lazy}
